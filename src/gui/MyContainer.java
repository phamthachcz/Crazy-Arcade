...
public class MyContainer extends JPanel{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8822734576162952308L;
	...
	public void setShowMenu(){
		...
		GameSound.getIstance().getAudio(GameSound.BG_MENU).loop();
	}
	public void setShowPlay(){
		...
		GameSound.getIstance().getAudio(GameSound.GAME_START).play();
		GameSound.getIstance().getAudio(GameSound.BG_MAP1).loop();
	}
